...
export const data = {
  ...
  contentBlocks: [
    ...
    },
    {
      ...
      description: [
        " Javascript/Typescript, React, Next.js, Storybook, GCP(Firebase, Firestore, App Engine, Cloud Run, Cloud Functions, Cloud Storage, etc.), AWS (DynamoDB, Amplify, AppSync, Lambda, CloudFormation), GraphQL, Apollo, TDD, Jest, Styled Components, VS Code, Redux, MobX, Ruby, Ruby on Rails, RSpec, HTML, CSS, SQL, MATLAB, C++, R",
      ],
    },
    {
      type: BLOCK_TYPES.TEXT,
      title: "Interests",
      description: [
        "Travel - Pottery - Photography - Code - Attending Tech Events - Speaking at Events - Music - Golf - Reading",
      ],
    },
    {
